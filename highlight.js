...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("verilog",(()=>{"use strict";return e=>({name:"Verilog",
...
},relevance:0}]})})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("vhdl",(()=>{"use strict";return e=>({name:"VHDL",
...
begin:"'[A-Za-z](_?[A-Za-z0-9])*",contains:[e.BACKSLASH_ESCAPE]}]})})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("llvm",(()=>{"use strict";function e(...e){
